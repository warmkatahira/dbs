<div class="bg-white border border-gray-600 shadow-md mr-3">
    ...
    <form method="GET" action="{{ route($searchRoute) }}" class="m-0">
        <div class="flex flex-col px-3">
            ...
            <x-search.date-period idFrom="search_monthly_cost_ym_from" idTo="search_monthly_cost_ym_to" label="月額経費年月" type="month" />
            <x-search.select id="search_base_id" label="拠点" :searchConditions="$bases" value="base_id" text="base_name" />
