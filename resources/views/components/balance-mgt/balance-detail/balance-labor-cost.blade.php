<div class="flex flex-col">
    ...
    <div class="flex flex-row text-sm mb-2">
        <p class="w-40 py-1 pl-2 bg-theme-main text-white">正社員</p>
    ...
    <div class="flex flex-row text-sm mb-2">
        <p class="w-40 py-1 pl-2 bg-theme-main text-white">契約社員</p>
    ...
    <div class="flex flex-row text-sm mb-2">
        <p class="w-40 py-1 pl-2 bg-theme-main text-white">パート</p>
