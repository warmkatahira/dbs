<div class="bg-white w-1300px px-5 pb-5 pt-2 text-sm flex flex-row">
    ...
    <div class="ml-10">
        ...
        <div class="flex flex-row border-b-2 border-black w-52 bg-orange-200">
        ...
        <div class="flex flex-row border-b-2 border-black w-52 bg-rose-200">
        ...
        <div class="flex flex-row border-b-2 border-black w-52">
