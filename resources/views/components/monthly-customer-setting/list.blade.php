        ...
        <table class="text-sm block whitespace-nowrap">
            <thead>
                <tr class="text-center text-white bg-gray-600 sticky top-0">
                    ...
                    <th class="font-thin py-3 px-2">月額経費分配割合<i class="las la-question-circle ml-1 la-lg tippy_monthly_cost_setting_allocation_ratio"></i></th>
            ...
            <tbody class="bg-white">
                @foreach($monthlyCustomerSettings as $monthly_customer_settings)
                    <tr class="hover:bg-theme-sub cursor-default">
                        ...
                        <td class="py-1 px-2 border text-right">{{ $monthly_customer_settings->monthly_cost_setting_allocation_ratio }}<i class="las la-percent"></i></td>
