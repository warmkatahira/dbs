...
<x-app-layout>
    ...
    <div class="flex flex-row items-start mb-2">
        <!-- 検索条件 -->
        <x-balance-mgt.balance-list.search :bases="$bases" :customers="$customers" :sortFieldConditions="$sort_field_conditions" :sortDirectionConditions="$sort_direction_conditions" searchRoute="balance_list.index" resetRoute="balance_list.index" />
        <!-- カレンダー表示 -->
