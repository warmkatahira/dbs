            ...
            <tbody id="customer_shipping_method_tbody" class="bg-white">
                @foreach($balance_shipping_fees as $balance_shipping_fee)
                    <tr>
                        ...
                        <td class="py-1 px-2 border"><input type="tel" name="shipping_fee_quantity_sales[]" class="text-xs text-right py-1 w-20 numeric-input shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_quantity_sales }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_unit_price_sales[]" class="text-xs text-right py-1 w-20 numeric-input shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_unit_price_sales }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_amount_sales[]" class="text-xs text-right py-1 w-24 numeric-input" value="{{ $balance_shipping_fee->shipping_fee_amount_sales }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><input type="tel" name="shipping_fee_quantity_cost[]" class="text-xs text-right py-1 w-20 numeric-input shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_quantity_cost }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_unit_price_cost[]" class="text-xs text-right py-1 w-20 numeric-input shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_unit_price_cost }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_amount_cost[]" class="text-xs text-right py-1 w-20 numeric-input" value="{{ $balance_shipping_fee->shipping_fee_amount_cost }}" autocomplete="off"></td>
                        <td class="py-1 px-2 border"><input type="tel" name="shipping_fee_note[]" class="text-xs text-left py-1 w-48" value="{{ $balance_shipping_fee->shipping_fee_note }}"></td>
                        <input type="hidden" name="shipping_method_id[]" value="{{ $balance_shipping_fee->shipping_method_id }}">
                    </tr>
                @endforeach
                <button class="p-5 bg-theme-main text-white">aaaaaaaaaaaaaaaa</button>
