            ...
            <tbody id="customer_shipping_method_tbody" class="bg-white">
                @foreach($balance_shipping_fees as $balance_shipping_fee)
                    <tr class="">
                        ...
                        <td class="py-1 px-2 border"><input type="tel" name="shipping_fee_quantity_sales[]" class="text-xs text-right py-1 w-20 shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_quantity_sales }}" data-category="sales"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_unit_price_sales[]" class="text-xs text-right py-1 w-20 shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_unit_price_sales }}" data-category="sales"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_amount_sales[]" class="text-xs text-right py-1 w-24" value="{{ $balance_shipping_fee->shipping_fee_amount_sales }}"></td>
                        <td class="py-1 px-2 border"><input type="tel" name="shipping_fee_quantity_cost[]" class="text-xs text-right py-1 w-20 shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_quantity_cost }}" data-category="cost"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_unit_price_cost[]" class="text-xs text-right py-1 w-20 shipping_fee_calc" value="{{ $balance_shipping_fee->shipping_fee_unit_price_cost }}" data-category="cost"></td>
                        <td class="py-1 px-2 border"><i class="las la-yen-sign mr-1"></i><input type="tel" name="shipping_fee_amount_cost[]" class="text-xs text-right py-1 w-20" value="{{ $balance_shipping_fee->shipping_fee_amount_cost }}"></td>
